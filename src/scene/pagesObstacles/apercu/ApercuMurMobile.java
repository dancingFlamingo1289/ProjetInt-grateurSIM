 ...
 */
public class ApercuMurMobile extends JPanel {
	...
	private MurMobile murBougeant;
	/**
	 * Création de panneau
	 */
	//Aimé Melançon
	public ApercuMurMobile() {
		setLayout(null);
	...
	public void paintComponent(Graphics g) {
		...
		murBougeant = new MurMobile(vecMilieu, hauteur, largeur, angle, vitesseCroisiere, couleur);
	...
	public Obstacle getObstacle() {
		...
		return new MurMobile(position, hauteur, largeur, angle,vitesseCroisiere, couleur);
	}
}
